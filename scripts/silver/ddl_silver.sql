...
-- Description:
--   This script creates the silver layer tables for staging 
...
-- Repo Use: Version-controlled script for Git
-- ===========================================================
...
CREATE TABLE silver.erp_px_cat_g1v2(
    ...
    dwh_create_date TIMESTAMP DEFAULT CURRENT_TIMESTAMP -- the record's load timestamp
);
